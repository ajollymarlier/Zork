...
public class EffectItem extends ConsumableItem {
	public static final String[] EFFECT_ITEMS = {"potion", "Speedy", "Go_Go_Go", "mini_potion", "tiny_potion", "potion", "super_potion","health_potion", "weak_stimulant", "magma_stimulant"};
